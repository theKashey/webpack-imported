...
const LinkPreload: React.FC<UnknownLink> = ({ href, as, type, anonymous, ...rest }) => (
  <link rel="preload" as={as} href={href} type={type} crossOrigin={anonymous ? 'anonymous' : undefined} {...rest} />
);
const LinkPrefetch: React.FC<UnknownLink> = ({ href, as, type, anonymous, ...rest }) => (
  <link rel="prefetch" as={as} href={href} type={type} crossOrigin={anonymous ? 'anonymous' : undefined} {...rest} />
);
